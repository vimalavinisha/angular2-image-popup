...
// ];
//
// const CLOSE_YES_CONFIGS: Array<any> = [{ extUrl: false, close: true }, { extUrl: true, close: true }, { extUrl: true }];
//
// const CLOSE_NO_CONFIGS: Array<any> = [{ extUrl: false, close: false }, { extUrl: true, close: false }];
//
// const WRONG_CONFIG: Array<any> = [null, undefined];
//
// function initTestBed() {
//   TestBed.configureTestingModule({
//     declarations: [UpperButtonsComponent, DownloadButtonDirective, CloseButtonDirective, ExternalUrlButtonDirective]
