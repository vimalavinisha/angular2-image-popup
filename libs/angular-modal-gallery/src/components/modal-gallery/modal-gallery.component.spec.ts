...
//     null // url
//   ),
//   new Image(5, './app/assets/images/gallery/img5.jpg', undefined, undefined, undefined),
//   new Image(6, './app/assets/images/gallery/img5.jpg', null, null, null)
// ];
//
...
//           expect(extUrlBtn.properties['hidden']).toBe(
//             btnConfig.extUrl === false || !IMAGES[imgIndex].extUrl || !btnConfig.extUrl
//           );
...
//         `Image ${index + 1}/${IMAGES.length}` + (IMAGES[index].description ? ` - ${IMAGES[index].description}` : '');
//
...
//
//         const expectedDescription: string =
//           `${customDesc.imageText}${index + 1}${customDesc.numberSeparator}${IMAGES.length}` +
