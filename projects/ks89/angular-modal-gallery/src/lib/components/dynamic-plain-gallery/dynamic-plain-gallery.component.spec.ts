...
import { DynamicPlainGalleryComponent } from './dynamic-plain-gallery.component';
...
let comp: DynamicPlainGalleryComponent;
let fixture: ComponentFixture<DynamicPlainGalleryComponent>;
...
function initTestBed() {
  return TestBed.configureTestingModule({
    declarations: [DynamicPlainGalleryComponent, SizeDirective, WrapDirective, DirectionDirective, ATagBgImageDirective]
  }).compileComponents();
}

describe('DynamicPlainGalleryComponent', () => {
  beforeEach(async(() => {
    return initTestBed();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(DynamicPlainGalleryComponent);
